...
ColVis.prototype = {
	...
	"_fnCollectionShow": function ()
	{
		...
		/* This results in a very small delay for the end frontend but it allows the animation to be
...
ColVis.defaults = {
	...
	/**
	 * Callback function to tell the frontend when the state has changed
